...
basic.forever(function () {
    ...
    if (temp_flag == 1) {
        ...
        for (let index = 0; index < 1; index++) {
            I2C_LCD1602.ShowString("Steam sensor", 0, 0)
        }
        ...
        if (pins.digitalReadPin(DigitalPin.P1) == 0) {
            if (dangerous_flag == 0) {
                I2C_LCD1602.clear()
                I2C_LCD1602.ShowString("dangerous", 0, 0)
                basic.pause(500)
                dangerous_flag = 1
                security_flag = 0
            }
            ...
            if (security_flag == 0) {
                I2C_LCD1602.clear()
                I2C_LCD1602.ShowString("security", 0, 0)
                basic.pause(500)
                dangerous_flag = 0
                security_flag = 1
            }
        ...
        if (pins.digitalReadPin(DigitalPin.P15) == 1) {
            if (someone_flag == 0) {
                I2C_LCD1602.clear()
                I2C_LCD1602.ShowString("someone", 0, 0)
                basic.pause(500)
                someone_flag = 1
            }
        } else {
            if (someone_flag == 1) {
                I2C_LCD1602.clear()
                I2C_LCD1602.ShowString("No one", 0, 0)
                basic.pause(500)
                someone_flag = 0
            }
        }
